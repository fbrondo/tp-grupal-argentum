...
constexpr int SAFE_GOLD_X = PANEL_RIGHT_X + 19;  // 686 + 19 = 705
constexpr int SAFE_GOLD_Y = INVENTORY_Y + 244;   // 128 + 244 = 372

constexpr int EXCESS_GOLD_X = PANEL_RIGHT_X + 133;  // 686 + 133 = 819
constexpr int EXCESS_GOLD_Y = INVENTORY_Y + 244;    // 128 + 244 = 372
