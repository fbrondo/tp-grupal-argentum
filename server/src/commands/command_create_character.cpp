...
CreateCharacterCommand::CreateCharacterCommand(Id client_id, std::string&& name, std::string&& pass,
                                               TypeRace race, TypeClase clase):
        Command(client_id),
...
void CreateCharacterCommand::execute(World& world) { world.spawnPlayer(client_id); }
